 ...
 * @param   object  $post
 */
function afsp_notify_admin_on_publish( $post ) {
  ...
  switch($new_assigned) {
    // case 'Alexis':
    //   $emailto[] = 'aobrien@afsp.org';
    //   break;
    case 'Brett':
      $emailto[] = 'bwean@afsp.org';
      break;
    case 'Dozier':
      $emailto[] = 'jdozier-ezell@afsp.org';
      break;
    case 'Hannah':
      $emailto[] = 'hmoch@afsp.org';
      break;
    case 'Tara':
      $emailto[] = 'tcriscuolo@afsp.org';
      break;
  }
