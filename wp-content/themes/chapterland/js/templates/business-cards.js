    ...
    return (
      <section className="business-card">
        <form className="business-card-form" action="http://chapterland.org/wp-content/themes/chapterland/pdf-templates/pdf-business-cards.php/" method="post">
          ...
          <BusinessCrops crops={this.state.crops} onChange={this.handleChange('crops')} />
  ...
  render: function() {
    return (
      <div className="bc-form-title">
        ...
        <input type="text" name="title" value={this.props.title} onChange={this.props.onChange} required/>
      </div>
    );
  }
});
  ...
  render: function() {
    return (
      <div className="bc-form-email">
        ...
        <input type="email" name="email" value={this.props.email} onChange={this.props.onChange} required/>
      </div>
    );
  }
});
var BusinessCrops = React.createClass({
  render: function() {
    return (
      <div className="bc-form-email">
        <label for="crops">Crop Marks? </label>
        <input type="checkbox" name="crops" value={this.props.crops} onChange={this.props.onChange} />
      </div>
    );
  }
});
