...
/**
 *  Require modern tribe events customizations
 */
require('library/modern-tribe-events.php');
...
function chapterland_scripts() {
    ...
    wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Lato:400,700,900' );
...
/**
 * Load file that allows non super-admins to edit users.
 */
require get_template_directory() . '/inc/admin-edit-users.php';
