<?php if(have_rows('p_partner')) : ?>

<section class="partners container">
  <div class="modal__overlay"></div>

        <? while(have_rows('p_partner')) : the_row(); ?>
      
  <button class="partners__wrapper">
    
        <?php afsp_imgix('partners__image', true, 'p', '100vw', 2304, 768, 768, 768); ?>
  ...
  <div class="modal">
    ...
    <h3 class="partners__name"><?php echo get_sub_field('p_name'); ?></h3>
    <div class="partners__description"><?php echo get_sub_field('p_description'); ?></div>
    <a class="partners__button" href="<?php echo get_sub_field('p_link'); ?>" target="_blank">Visit our partner</a>
  </div>
...
<script>
  jQuery(document).ready(function($) {
    $('.partners__wrapper').on('click', function(e) {
