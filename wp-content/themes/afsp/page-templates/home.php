...
<section class="video-hero">
	<div class="video-hero__wrapper">
		<video class="video-hero__video" src="<?php the_field('vh_video'); ?>" autoplay loop></video>
		<img class="video-hero__image" src="<?php the_field('vh_poster') ?>" />
	</div>
...
<div id="mc_embed_signup" class="container__full" style="background-color: #055f74;">
	<div class="container--large" style="margin: 0 auto;">
	    ...
	    <div id="mc_embed_signup_scroll" class="email" style="margin: 0;">
	      <h2 class="email__cta">Sign-Up for Our Newsletter</h2>
...
<!--End mc_embed_signup-->
	...
	<section class="gallery js-flickity" data-flickity-options='{ "contain": true, "wrapAround": true, "pageDots": false, "autoPlay": true }'>
				
				<?php if(have_rows('c_carousel_image')) : while(have_rows('c_carousel_image')) : the_row();
				$image = get_sub_field('c_image');
				$mobile_image = get_sub_field('c_mobile_image');
				if(get_sub_field('link_to_internal_or_external_page') == 'Internal') :
					$link = get_sub_field('c_internal_link');
				else :
					$link = get_sub_field('c_external_link');
				endif; ?>
				
	  <div class="gallery-cell gallery-cell__full">
	  	<a href="<?php echo $link; ?>">
		  	<picture>
		  		<source srcset="<?php echo $image['url']; ?>" media="(min-width: 768px)"></source>
		  		<img class="" src="<?php echo $mobile_image['url']; ?>" />
		  	</picture>
	  	</a>
  	</div>
	  		<?php endwhile;
...
<section class="container">
	<h2 class="everyday-heroes__title">Suicide prevention starts with everyday heroes like you</h2>
	
				<?php if(have_rows('hf_home_faces')) : ?>
				
	<div id="home-carousel" class="gallery js-flickity everyday-heroes__carousel" data-flickity-options='{ "wrapAround": true, "pageDots": false, "autoPlay": true }'>			
					
				<?php	while(have_rows('hf_home_faces')) : the_row(); 
						$image = get_sub_field('hf_face_image');
          	...
          	$post_object = get_sub_field('hf_face_link');
						if($post_object) :
							$post = $post_object;
							setup_postdata($post); ?>
	...
	<div class="everyday-heroes__cta">
		<h3 class="everyday-heroes__connect">Connect with us</h3>
		<div class="everyday-heroes__icons">
			
				<?php if(get_field('sn_facebook')) : ?>
			
			<a href="https://facebook.com/<?php the_field('sn_facebook'); ?>" target="_blank"> 
				<svg class="social-icon facebook" viewBox="0 0 90 90">
					<g>
			...
			<a href="https://twitter.com/<?php the_field('sn_twitter'); ?>" target="_blank"> 
				<svg class="social-icon" viewBox="0 0 612 612">
				<g>
					<g>
			...
			<a href="https://instagram.com/<?php the_field('sn_instagram'); ?>" target="_blank"> 
				<svg class="social-icon" viewBox="0 0 97.395 97.395">
				<g>
			...
			<a href="https://youtube.com/user/<?php the_field('sn_you_tube'); ?>" target="_blank">			
				<svg class="social-icon" viewBox="0 0 90 90">
				<g>
			...
			<a href="https://plus.google.com/+<?php the_field('sn_google_plus'); ?>/posts" target="_blank">		
				<svg class="social-icon" viewBox="-297 389 16 16">
			...
			<a href="https://linkedin.com/company/<?php the_field('sn_linked_in'); ?>" target="_blank">			
			...
			<a href="http://themighty.com/partner/<?php the_field('sn_mighty'); ?>" target="_blank">	
				<svg class="social-icon" viewBox="-135 311.7 339.3 171.3">
					<g>
						<g>
				...
				$givingTuesday = new DateTime('2016-11-29');

				if($today == $givingTuesday) : // is it Giving Tuesday?
					require(locate_template('template-parts/modals/modal-giving-tuesday.php'));
...
<script>
	var faces = "<?php echo count(get_field('hf_home_faces')); ?>";
