...
function notify_survivor_day() {
	...
	$body            = 'Thank you. Your International Survivors of Suicide Loss Day event application has been submitted for review. If your application is accepted, we will create a webpage for your event within two weeks. Otherwise we will be in touch as soon as possible. If you have any questions, please contact the Loss & Healing team at survivorday@afsp.org.';
