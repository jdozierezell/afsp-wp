...
<div class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-pt-form-wrapper find-chapter__form-wrapper">
	...
	<form class="gmw-form gmw-form-<?php echo $gmw['ID']; ?>" name="gmw_form" action="<?php echo $gmw['search_results']['results_page']; ?>" method="get">
		<div class="find-chapter__form">
			...
			<div class="find-chapter__locator">
				...
				<!-- Address Field -->
				<?php gmw_search_form_address_field( $gmw, $id='', $class='find-chapter__input' ); ?>
