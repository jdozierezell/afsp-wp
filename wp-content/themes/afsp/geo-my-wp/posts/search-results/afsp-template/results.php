...
<div class="gmw-results-wrapper gmw-results-wrapper-<?php echo $gmw['ID']; ?> find-chapter__results-wrapper container">
	
	<?php do_action( 'gmw_search_results_start' , $gmw, $post ); ?>
	
	<!-- results count -->
	<div class="find-chapter__results-count">
		<span><?php gmw_results_message( $gmw, false ); ?>.<br><br>Addresses may be approximate. Always contact the location directly before traveling.</span>
	</div>
	
	<?php do_action( 'gmw_search_results_before_top_pagination' , $gmw, $post ); ?>
	
	<!--<div class="find-chapter__pagination-wrapper gmw-pt-top-pagination-wrapper">-->
		<!--  paginations -->
	...
	<!--  Results wrapper -->
	<div class="find-chapter__chapters-wrapper">
		...
		<?php while ( $gmw_query->have_posts() ) : $gmw_query->the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class( 'wppl-single-result '.$featured ); ?>>
				...
				<div class="wppl-title-holder">
					<a href="<?php echo the_permalink(); ?>" class="wppl-h2 find-chapter__link">
						<?php echo $post->post_count; echo '. '; the_title(); ?>
		    		...
		    		<div class="wppl-info-right">
		    			...
		    			<div class="wppl-address">
		    				<div class="address-wrapper">
						    	...
						    	<span class="wppl-address"><?php echo $address; ?></span>
						    </div>
		    			</div>
	...
	<!--  Pagination -->
	<div class="find-chapter__pagination-wrapper gmw-pt-pagination-wrapper gmw-pt-bottom-pagination-wrapper">
		<!--  paginations -->
		<?php gmw_per_page( $gmw, $gmw['total_results'], 'paged' ); ?><?php gmw_pagination( $gmw, 'paged', $gmw['max_pages'] ); ?>
	</div> 
